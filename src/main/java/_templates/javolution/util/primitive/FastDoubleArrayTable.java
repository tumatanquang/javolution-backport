...
/**
 * Implement <code>FastArrayTable</code> for the <code>double</code> primitive data type.
 * @since 5.7.1
 */
public strictfp class FastDoubleArrayTable implements Cloneable, RandomAccess, Serializable {
	...
	public Object/*FastDoubleArrayTable*/ clone() throws CloneNotSupportedException {
		/*@JVM-1.1+@
		if(true) {
			final FastDoubleArrayTable c = (FastDoubleArrayTable) super.clone();
	...
	public boolean addAll(int index, FastDoubleArrayTable c) {
	...
	public boolean equals(Object o) {
		...
		if(o == null || getClass() != o.getClass())
			return false;
		final FastDoubleArrayTable that = (FastDoubleArrayTable) o;
		if(size != that.size)
			return false;
		for(int i = 0; i < size; ++i)
