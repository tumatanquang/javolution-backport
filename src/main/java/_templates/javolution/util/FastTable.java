...
public class FastTable/*<E>*/extends FastAbstractList/*<E>*/ implements List/*<E>*/, Reusable, RandomAccess {
	...
	/**
	 * Holds whether null values are disallowed.
	 */
	private transient boolean _requireNotNull;
	/**
	 ...
	 *
	 * If the table is created with {@link FastTable#requireNotNull()},
	 * this method will not be able to increase its size.
	 *
	...
	public void setSize(int size) {
		...
		if(size > _size && _requireNotNull)
			throw new UnsupportedOperationException("Cannot expand with null padding when null values are disallowed");
	...
	public boolean addAll(int index, Collection/*<? extends E>*/ values) {
		...
		if(_requireNotNull) {
			for(final Iterator /*<? extends E>*/ checkIterator = values.iterator(); checkIterator.hasNext();) {
				if(checkIterator.next() == null)
					throw new NullPointerException("null value are not allowed");
			}
		}
	...
	/**
	 * Configures whether this table disallows {@code null} values.
	 * When enabled, {@code add()}, {@code set()}, and similar methods
	 * will throw {@code NullPointerException} if a {@code null} value
	 * is passed.
	 *
	 * @return {@code this}
	 */
	public FastTable/*<E>*/ requireNotNull() {
		_requireNotNull = true;
		return this;
	}
	/**
	 * Returns whether this table disallows null values.
	 */
	public boolean isNullDisallowed() {
		return _requireNotNull;
	}
